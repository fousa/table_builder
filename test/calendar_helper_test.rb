...
class CalendarHelperTest < ActionView::TestCase
  ...
  def setup
    ...
    @multi_day_events = [MultiDayEvent.new(3, 'Jimmy Page', Date.civil(2008, 12, 26), Date.civil(2008, 12, 27)),
  ...
  def test_calendar_for_with_multi_day_events
    output = calendar_for(@multi_day_events, :year=> 2008, :month => 12) do |c|
